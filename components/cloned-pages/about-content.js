...
<section style="margin-bottom:100px;">
        <div class="container">
            ...
            <div class="col-md-12 wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 1.1s; animation-delay: 0.3s; animation-name: fadeInUp;">
                <p>EduCtrl (<span style="font-style:italic;">pronounced as Edu Control</span>) Software is developed by <a target="_blank" href="https://www.sashinfo.com">Sash Info Services</a>, a Web/Mobile Software Development, Digital Agency. We are a team of techies with 10+ years’ experience. We are operating from Bengaluru (Bangalore) India, called as the Silicon Valley of India.</p>
